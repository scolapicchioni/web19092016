...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LocalStorageDataLayer = __webpack_require__(2);
	
	var _ViewModel = __webpack_require__(3);
	
	var vm = new _ViewModel.ViewModel(new _LocalStorageDataLayer.LocalStorageDataLayer());
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.LocalStorageDataLayer = undefined;
	...
	var LocalStorageDataLayer = exports.LocalStorageDataLayer = function () {
	    function LocalStorageDataLayer() {
	        _classCallCheck(this, LocalStorageDataLayer);
	
	        if (window.localStorage) {
	            if (localStorage.length === 0) {
	                var _trips = [];
	                _trips.push(new _Trip.Trip(1, "Roma", "Ciao Bella! Lasagna! Mamma!", "01/01/01", 9));
	                _trips.push(new _Trip.Trip(2, "Paris", "Landjaeger ham beef short ribs jowl salami meatball. Jowl spare ribs pastrami fatback capicola. Pig shankle drumstick tri-tip short ribs. Spare ribs venison leberkas jerky. Fatback frankfurter tri-tip venison. Filet mignon cupim drumstick bresaola, doner tenderloin pork chop.", "01/01/01", 8));
	                _trips.push(new _Trip.Trip(3, "Madrid", "Los tres caballeros.", "01/01/01", 5));
	                ...
	                try {
	                    for (var _iterator = _trips[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	    ...
	    _createClass(LocalStorageDataLayer, [{
	        key: "getAllTrips",
	        value: function getAllTrips() {
	            var _trips = [];
	            for (var i = 0; i < localStorage.length; i++) {
	                var obj = JSON.parse(localStorage[localStorage.key(i)]);
	                _trips.push(new _Trip.Trip(obj._id, obj._destination, obj._description, obj._date, obj._rating));
	            }
	            return _trips;
	        }
	    }, {
